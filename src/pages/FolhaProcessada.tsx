...
import { Search, CheckCircle2, Loader2, FileText, Undo2, Send } from 'lucide-react';
      ...
      <Dialog open={liberarDialogOpen} onOpenChange={setLiberarDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            >
              {liberarMutation.isPending ? <Loader2 className="h-4 w-4 animate-spin mr-1" /> : <Send className="h-4 w-4 mr-1" />}
              Confirmar Liberação
            </Button>
          </DialogFooter>
        </DialogContent>
